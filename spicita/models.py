...
class Extra(models.Model):
    ...
    EXTRAS = models.TextChoices('Extras', ('sprite', 'coke', 'pepsi',
                                           'chicken', 'beef', 'fufu', 'soup'))
...
class OrderItem(models.Model):
    dish = models.ForeignKey("spicita.Dish", blank=True, on_delete=models.CASCADE, null=True)
    extra = models.ForeignKey('spicita.Extra', blank=True, on_delete=models.CASCADE, null=True)
...
class Order(models.Model):
    ...
    total_price = models.PositiveIntegerField(verbose_name='Total Price of Order (Naira)', editable=False)
    ...
    ticket = models.UUIDField(primary_key=True, default=uuid4, editable=False, unique=True)
